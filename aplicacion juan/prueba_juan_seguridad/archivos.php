	...
	while ( $archivo = readdir( $directorio ) ) 
	{
	    ...
	    else
	    {
			...
			if ( $archivoYExtension[ 1 ] == 'xhtml' )
			{
				...
				{
	    			$contenido_body 	= " lang='es-ES' xml:lang='es-ES' onkeydown='return false'  draggable='false' style='-webkit-touch-callout: none; -webkit-user-select: none; -khtml-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none;".str_replace('"',"",$dentroCuerpo[ 1 ] )."'";
				}else
				{
				...
				file_put_contents( $archivoYExtension[ 0 ].".".$archivoYExtension[ 1 ] , $contenidoTotal );								
			}			
