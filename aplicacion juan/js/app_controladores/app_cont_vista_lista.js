angular.module('app_Fernando',['datatables']).controller('ControladorFer', function($scope,DTOptionsBuilder,DTColumnBuilder ){
     ...
     // simple_numbers"
      ...
      .withLanguage({
            ...
            "sInfo":           "Mostrando  : Hasta _END_ de _TOTAL_ ",
            "sInfoEmpty":      "Mostrando 0 hasta 0 de 0 ",
            "sInfoFiltered":   "(El Filtro se hizo sobre un total de  _MAX_ Registros)",
            "sInfoPostFix":    "",
            "sInfoThousands":  ",",
            ...
            "oAria": {
                ...
                "sSortDescending": ": activar para ordenar la columna Desendente"
            }
        });;
