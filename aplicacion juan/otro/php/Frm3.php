	...
	<div class="ventana">
		...
		<div class="form" style="width:515px">
			<!-- cierra todo lo que abarque -->
				...
				<form class="form1" action="Frm3.php" method="post">
                ...
                switch($accion){ 
                	      	...
                	      	?><script>AbrirTelon();</script><? 
                                                          if($ingresar == "Ingresar registro" and ( $nombre == "" or $apellido == "" or $cedula == "" or $genero == "" or $edad == "" or $dpto == "---" or $mun == "---" or $direccion == "" or $email == "" or $fecha == "")){
																...
																//$verlistad=0;
																?>
															    <div id="divtitulo"><h1 id ="h12">ADICIONAR PASTORES</h1></div>
																...
																<table >
										                           ...
										                           <tr>
																	...
																	<tr>
																		<td></td>
																		<td><input type="hidden" name="accion" value="<?=$accion;?>"><input type="submit" name="ingresar" value="Ingresar registro"></td>
																	</tr>
																	<? if($activar == "si"){?>
																	<tr>
																		<td></td>
	...
	<div class="texto">
		...
		<div style="width: 100%" >
	      <?  
			...
			{
	             ?><div style="width: 100px; float: left"><? echo  $p_idcon = mysql_result($result_listar,$i,"pastor_id"); ?></div><?
	             ?><div style="width: 200px; float: left"><? echo  $nombre = mysql_result($result_listar,$i,"nombre"); ?></div><?
	             ?><div style="width: 200px; float: left"><? echo " <a href='./Frm3.php?accion=editar&id=$p_idcon'>editar</a> <a href='./Frm3.php?accion=borrar&id=$p_idcon'>- borrar </a> <br>"; ?></div><?
	             ?> <div style="clear: both;"></div><?
	        }         		
	      ?>
        <p align="center"><a  href="Frm3.php?accion=ingresar">Adicionar Registro</a></p>
		</div>	
