...
//LLAMA A EL PHP QUE POSEE LA CONEXION
...
// FILTRO PARA INGRESAR INFORMACION 
		...
		<div style="width: 100%" >
	      <?  
			...
			for($i=0;$i<$numrows_listar;$i++)
			{
	              ...
	              echo  $nombre = mysql_result($result_listar,$i,"nombre"); echo " <a href='./Frm.php?accion=editar&id=$p_idcon'>editar</a> - borrar <br>";
	        }         		
	      ?>
